...
export class P90M200 implements ICustomItem
{
    public main(mainProperties: MainProperties): void
    {
        ...
        const newId = "shP90M200";
        const newFilter = "5cc70093e4a949033c734312";
        const newClone = "5cc70093e4a949033c734312";
        const newLongName = "SH 200 Round Magazine";
        const newShortName = "P90 200";
        const newDescription = "200 Round P90 Magazine by Sasha Himik.";
        const newLL = 1;
        ...
        items[newId]._props.Cartridges[0]._max_count = 200;
