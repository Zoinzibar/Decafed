...
export class Ben25Magazine implements ICustomItem
{
    public main(mainProperties: MainProperties): void
    {
        ...
        const newItemFleaPrice = 25000;
        const newItemCategory = "5b5f754a86f774094242f19b";
        const newId = "shBenelli25Ultra";
        const newFilter = "625ff31daaaa8c1130599f64";
        const newClone = "625ff31daaaa8c1130599f64";
        const newLongName = "SH 25 Round Benelli Magazine";
        const newShortName = "BEN 25";
        const newDescription = "25 Round Benelli Magazine by Sasha Himik.";
        const newLL = 1;
        ...
        items[newId]._props.Cartridges[0]._max_count = 25;
