...
export class LootElectronicsSmallBox implements ICustomItem
{
    itemId: string = "shLootElectronicsSmallBox";
    public main(mainProperties: MainProperties): void
    {
        ...
        pes7Lib.createItem({
            ...
            newName: "SH Small Electronics Box",
            newShortName: "Small Electronics Box",
            newDescription: "Electronics Box by Sasha Himik \nItems inside:1-2;",
