...
export class ArmorEquipmentLargeBox implements ICustomItem
{
    itemId: string = "shArmorEquipmentLargeBox";
    public main(mainProperties: MainProperties): void
    {
        ...
        pes7Lib.createItem({
            ...
            newName: "SH Equipment Large Box",
            newShortName: "Equipment Large Box",
