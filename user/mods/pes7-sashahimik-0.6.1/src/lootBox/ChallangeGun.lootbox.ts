...
export class ChallangeGunBox implements ICustomItem
{
    itemId: string = "shChallangeGunBox";
            ...
            .setRandomLootContainerLoot(this.itemId, 
                {"rewardCount": 1, "foundInRaid": true, "rewardTplPool": 
                    pes7Lib.getAllFixedItemsForCase((item) => !(
                        item._parent === "5447b5f14bdc2d61278b4567" || item._parent === "5447bed64bdc2d97278b4568" || item._parent === "5447b5e04bdc2d62278b4567"
                    ))
                }
            );
    }
